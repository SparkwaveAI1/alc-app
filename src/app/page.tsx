  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FFF7ED', fontFamily: "'Be Vietnam Pro', sans-serif" }}>
      ...
      <div style={{ padding: '28px 16px 100px' }}>
        ...
        {/* Large card */}
        <Link href="/subject" style={{ textDecoration: 'none', display: 'block', marginBottom: 13 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12 }}>
          {[
            ...
            <button key={item.label} style={{ background: item.bg, borderRadius: 20, padding: '16px 8px', border: 'none', cursor: 'pointer', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, boxShadow: '0 4px 14px rgba(0,0,0,0.1)' }}>
