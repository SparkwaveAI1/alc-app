    ...
    <div style={{ minHeight: '100vh', background: '#FDFBF7', fontFamily: "'DM Sans', sans-serif", paddingBottom: 90 }}>
      ...
      <div style={{ padding: '24px 16px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 14, marginBottom: 24 }}>
          {[
            { icon: '✍️', label: 'Write', desc: 'Express your thoughts', href: '/create/write' as const, color: 'linear-gradient(135deg, #7C5CBF, #9C7DD4)' },
            { icon: '🎨', label: 'Draw', desc: 'Visual creation', href: '/create/draw' as const, color: 'linear-gradient(135deg, #E8715A, #F59E0B)' },
            { icon: '📹', label: 'Record', desc: 'Coming soon', disabled: true, color: 'linear-gradient(135deg, #A0AEC0, #CBD5E0)' },
            { icon: '📝', label: 'Note', desc: 'Quick thoughts', href: '/log' as const, color: 'linear-gradient(135deg, #4CAF7C, #68D391)' },
          ].map((c: any) => {
            const inner = (
              <div style={{
