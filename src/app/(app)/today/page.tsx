    ...
    <div style={{ minHeight: '100vh', background: '#FFF7ED', fontFamily: "'Be Vietnam Pro', sans-serif" }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1, marginTop: 16 }}>
          <div style={{
            ...
            boxShadow: '0 4px 14px rgba(6,95,70,0.5)',
          }}>
      ...
      <div style={{ padding: '28px 16px 120px' }}>
        ...
        <Link href="/subject/ancient-egypt" style={{ textDecoration: 'none', display: 'block', marginBottom: 13 }}>
          <div style={{
            borderRadius: 22,
            background: 'linear-gradient(135deg, #78350F 0%, #92400E 35%, #C2410C 70%, #EA580C 100%)',
            padding: '18px 18px 16px',
            position: 'relative',
            minHeight: 185,
            overflow: 'hidden',
            boxShadow: '0 8px 28px rgba(120,53,15,0.4)',
          }}>
            {/* Pyramid silhouettes */}
            ...
            <div style={{ color: '#fff', fontSize: 25, fontWeight: 700, fontFamily: "'Plus Jakarta Sans', sans-serif", marginBottom: 40 }}>
              Ancient Egypt
            </div>
        ...
        {/* TWO SMALL CARDS */}
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 13, marginBottom: 32 }}>

          {/* Creative Writing — forest green */}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12 }}>
          {[
            { icon: '📓', label: 'Journal', bg: 'linear-gradient(135deg, #8DF7CC, #5EE8B2)', color: '#065F46' },
            { icon: '🎨', label: 'Art',     bg: 'linear-gradient(135deg, #F7D8FF, #E8B8FF)', color: '#7C3AED' },
            { icon: '📝', label: 'Notes',   bg: 'linear-gradient(135deg, #FFE2DC, #FFBCB2)', color: '#9A3412' },
          ].map(item => (
