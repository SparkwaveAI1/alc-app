        ...
        <Link href="/subject/ancient-egypt" style={{ textDecoration: 'none' }}>
          <div style={{
            ...
            <div style={{ position: 'absolute', bottom: 0, right: 12, opacity: 0.3 }}>
              {/* Big pyramid */}
              <div style={{ width: 0, height: 0, borderLeft: '55px solid transparent', borderRight: '55px solid transparent', borderBottom: '75px solid rgba(255,220,150,0.9)', marginBottom: 0 }} />
            </div>
            ...
            <div style={{ position: 'absolute', top: 30, right: 100, color: 'rgba(255,255,255,0.4)', fontSize: 8 }}>✦</div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 13, marginBottom: 28 }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              background: 'rgba(0,0,0,0.25)', borderRadius: 9, padding: '4px 9px', marginBottom: 8,
            }}>
              <span style={{ fontSize: 10 }}>✍️</span>
              <span style={{ color: '#fff', fontSize: 10, fontWeight: 700, letterSpacing: '0.5px' }}>WRITING</span>
            </div>
            <div style={{ color: '#fff', fontSize: 16, fontWeight: 700, fontFamily: "'Plus Jakarta Sans', sans-serif", lineHeight: 1.25, marginBottom: 16 }}>
              Creative Writing
            </div>
            <div style={{
              display: 'inline-flex', alignItems: 'center', gap: 4,
              background: 'rgba(0,0,0,0.25)', borderRadius: 9, padding: '4px 9px',
            }}>
